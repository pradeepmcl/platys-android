...
public class DbxModeChooserActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_dbx_mode_chooser);
    ...
    mSubmit.setOnClickListener(new OnClickListener() {
      public void onClick(View v) {
        ...
        if (mLoggedIn) {
          ...
          mApi.getSession().startAuthentication(DbxModeChooserActivity.this);
        }
      }
    });
    ...
    mRoulette.setOnClickListener(new OnClickListener() {
      public void onClick(View v) {
        DownloadRandomPicture download = new DownloadRandomPicture(DbxModeChooserActivity.this,
            mApi, PHOTO_DIR, mImage);
        download.execute();
      }
    });
