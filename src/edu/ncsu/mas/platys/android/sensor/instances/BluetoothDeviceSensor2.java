...
public class BluetoothDeviceSensor2 implements Sensor {

  private static final String TAG = "Platys" + BluetoothDeviceSensor2.class.getSimpleName();
  ...
  public BluetoothDeviceSensor2(Context context, Handler handler, SensorDbHelper dbHelper,
      int sensorIndex) {
    mContext = context;
    mHandler = handler;
