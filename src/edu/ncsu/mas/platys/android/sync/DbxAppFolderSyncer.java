...
public class DbxAppFolderSyncer implements Runnable {

  private static final String TAG = "Platys" + DbxAppFolderSyncer.class.getSimpleName();
  ...
  public DbxAppFolderSyncer(Context context, Handler serviceHandler, SensorDbHelper sensorDbHelper) {
